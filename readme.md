...
## 背景
  ...
  React-hooks虽然已正式发布很久，hooks的相关资料也没少看，但由于使用React机会较少，实际使用时经常要再查阅资料。而官网的示例并不能包含常用场景，细节散落在各个地方，遂决定做一次分享，将React的hooks的基本用法，及注意点做分享,也方便大家查阅。如有错误的地方或可以补充进来的示例欢迎大家直接修改此分享文档的错误之处。
